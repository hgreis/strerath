		...
		<?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div class="greybox">
					...
					<div class="panel">
						...
						onclick="window.location.href='/edit_customer/<?php echo e($customer->id); ?>'">
							EDIT
						</button>
					</div>
				</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/strerath/resources/views/pages/customer.blade.php ENDPATH**/ ?>