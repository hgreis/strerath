				...
				<div class="flip">
					<table style="width: 100%">
						<tr>
							...
							<th><?php echo e($mission->kunde); ?></th>
						</tr>
					</table>
				</div>
				<div class="panel">
					...
					<button type="button" class="form-control" onclick="window.location.href='/mission/view/<?php echo e($mission->id); ?>/driver'">EDIT</button>
				</div>
			</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<script>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/StrerathTransporte/resources/views/pages/mission/nodeliverynote.blade.php ENDPATH**/ ?>